...
if (!function_exists('admin_notifications_path')) {
    function admin_notifications_path() {
        return __DIR__ . '/admin_notifications.json';
    }
}

if (!function_exists('load_admin_notifications')) {
...
if (!function_exists('save_admin_notifications')) {
...
if (!function_exists('delete_admin_notification')) {
...
if (!function_exists('clear_admin_notifications')) {
